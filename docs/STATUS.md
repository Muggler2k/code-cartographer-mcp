...
`context/sessions/2026-06-11_vb-provider-adr-0033.md` and
`context/00_index/index.md`; design is recorded in ADRs 0001–0033 under
`context/07_decisions/` (ADR 0028 — the v0.2 roadmap; ADR 0032 — C# tier parity; ADR 0033 — the Visual Basic provider tier).
